...
$('#addSubcategoryForm').validate({
    ...
    submitHandler: function () {
		...
		var addSubcategory_url = "http://localhost:8083/test-for-sure/test/add-subcategory";
        var type = 'POST';
        var requestData = {};
...
function getSubcategories(categoryId){
				...
				$.ajax({
                url: "http://localhost:8083/test-for-sure/test/get-subcategory?categoryId="+categoryId,
                type: "GET",
