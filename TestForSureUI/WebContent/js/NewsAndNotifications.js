...
$('#btnAddNews').on('click', function(){
	...
	console.log("Inside add news");
        ...
        var addNews_url = "http://localhost:8083/test-for-sure/news-notifications/insert-news";
        var type = 'POST';
        var requestData = {};
...
$('#btnUpdateSubmit').on('click', function(){
	...
	var id = ((localStorage.getItem('updateButtonId')).split('-'))[1];
        ...
        var updateNews_url = "http://localhost:8083/test-for-sure/news-notifications/update-news";
        var type = 'PUT';
        var requestData = {};
		requestData.id = id;
		requestData.headline=headline;
...
function editNews(id){
	...
	var getNews_url = "http://localhost:8083/test-for-sure/news-notifications/get-news?newsId="+newsId;
        $.ajax({
            url: getNews_url,
            type: type,
			contentType: 'application/json',
...
$('#btnYes').on('click', function(){
	...
	var type='PUT';
	var deleteNews_url = "http://localhost:8083/test-for-sure/news-notifications/delete-news?newsId="+id;
	$.ajax({
            url: deleteNews_url,
            type: type,
			contentType: 'application/json',
