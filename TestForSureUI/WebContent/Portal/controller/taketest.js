				...
				"<div class='test col-xs-12 col-sm-12 col-md-12 col-lg-12 container'>"+
					...
					"<div class='test-ques-status xs-12 col-sm-12 col-md-3 col-lg-3'>"+
						...
						"<div class='ques-status-info'>"+
							"<div class='main-status'><div class='status-info not-visited'><span>0</span></div><span class='status-span'>Not Visited</span></div>"+
							"<div class='main-status'><div class='status-info answered'><span>0</span></div><span class='status-span'>Answered</span></div>"+
							"<div class='main-status'><div class='status-info unanswered'><span>0</span></div><span class='status-span'>Unanswered</span></div>"+
							"<div class='main-status'><div class='status-info marked'><span>0</span></div><span class='status-span'>Marked For Review</span></div>"+
							"<div class='main-status'><div class='status-info marked-answered'><span>0</span></div><span class='status-span'>Marked For Review & Answered</span></div>"+
						"</div>"+
					"</div>"+
				"</div>"+
